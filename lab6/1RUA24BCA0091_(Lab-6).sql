...
-- 05:59:21	SELECT USER(),         @@hostname AS Host_Name,         VERSION() AS MySQL_Version,         NOW() AS Current_Date_Time LIMIT 0, 1000	1 row(s) returned	0.000 sec / 0.000 sec
...
select department_id, max(salary) as 'Max', min(salary) as 'Min', avg(salary) as 'Average'
from employees
group by department_id
...
-- Paste the output of above code and comment your output
/*
# department_id	Max	Min	Average
	7000.00	7000.00	7000.000000
10	4400.00	4400.00	4400.000000
20	13000.00	6000.00	9500.000000
30	11000.00	2500.00	4150.000000
40	6500.00	6500.00	6500.000000
50	8200.00	2100.00	3475.555556
60	9000.00	4200.00	5760.000000
...
desc employees;
select year(hire_date), count(employee_id) as 'Total'
from employees
